...
- Add `script/generate_official_suite_report.rb` and `rake conformance:official_cases` to make the checked-in per-case report artifact reproducible. Official suite (`fhir-test-cases` commit `ebb15f74f95a4731e59099c4244eeed734c9e447`, 935 cases): 489 pass, 403 defect, 43 unsupported, 0 host-dependent, 0 not-run (previously 416/519/0/0/0).
